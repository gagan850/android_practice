...
//        mMap.setOnMapLongClickListener(this);
        ...
        try {
            List<Address> addlessList = geocoder.getFromLocationName("17050, Aggarwal Colony, Bathinda",1);
            Address address = addlessList.get(0);

            LatLng latLn = new LatLng(address.getLatitude(), address.getLongitude());
            //Adding marker to map
            mMap.addMarker(new MarkerOptions()
                    .position(latLn) //setting position
